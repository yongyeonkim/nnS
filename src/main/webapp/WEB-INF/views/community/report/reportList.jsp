...
<div id="content">
   ...
   <script type="text/javascript">
      ...
      function fn_openReportList(){
         ...
         comSubmit.setUrl("<c:url value='/nnS/community/reportList' />");
         comSubmit.submit();
      }
      
      function fn_openReportUpdate(){
         var idx = "${map.NUM}";
         var comSubmit = new ComSubmit();
         comSubmit.setUrl("<c:url value='/nnS/community/reportUpate' />");
      ...
      function fn_deleteReport(){
         var comSubmit = new ComSubmit();
         comSubmit.setUrl("<c:url value='/sample/deletereport' />");
